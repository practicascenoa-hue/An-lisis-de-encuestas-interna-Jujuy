...
if df_raw is not None:
    ...
    with tab3:
        ...
        st.plotly_chart(px.bar(df_v, x='Mes', y=col_fecha_nombre, color=col_fecha_nombre, color_continuous_scale='Sunset'), use_container_width=True)

    # --- TAB 4: RECLAMOS VS PROMOTORES (Lógica Refinada) ---
    with tab4:
        ...
        if len(df_mes) > 0:
            def clasificar_intencion(row):
                ...
                # Limpiar texto de relleno automático
