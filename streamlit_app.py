...
st.markdown("""
    ...
    /* MODIFICACIÓN: FORZAR QUE EL TEXTO DE LAS TABLAS HAGA WRAP Y NO SE CORTE */
...
if df_raw is not None:
    ...
    # Limpieza global de indicadores para asegurar todas las pestañas
    ...
    # Refrescar df_mes con datos limpios
    ...
    # --- TAB 4: RECLAMOS (CON MEJORAS DE CLASIFICACIÓN Y WRAP) ---
    with tab4:
