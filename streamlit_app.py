...
if df_raw is not None:
    ...
    # Limpiamos todo el dataframe de origen para evitar errores en cualquier pestaña
        ...
        if len(df_mes) > 0:
            ...
            if st.session_state.f_tipo:
                ...
                if st.session_state.f_tipo == "NPS":
                    ...
                    cols = [col_cliente, col_asesor, col_nps_puntaje, df_raw.columns[17]]
                else:
                    ...
                    cols = [col_cliente, col_asesor, col_csi_final, df_raw.columns[8], df_raw.columns[12], df_raw.columns[14]]
    ...
    with tab2:
        if len(df_mes) > 0:
            ...
            st.plotly_chart(px.bar(df_as, x=col_asesor, y='Encuestas', color='Encuestas', color_continuous_scale='Blues', text='Encuestas'), use_container_width=True)
            ...
            df_res['% Cumplimiento'] = (df_res['Recibio_Seg_Count'] / df_res
