...
# Inicializar estados para evitar el NameError de la imagen
...
if df_raw is not None:
    ...
    # Mapeado (H=7, I=8, L=11, M=12, N=13, O=14, R=17, T=19)
    ...
    if len(df) > 0:
        ...
        # TABLA DE AUDITORÍA CON CSI INDIVIDUAL
        st.markdown("---")
        if st.session_state.f_tipo and st.session_state.f_val:
            ...
            # Incluimos el CSI (Col T) para que veas el 56,67
            ...
            # Ordenamos de menor CSI a mayor CSI para ver primero lo peor
